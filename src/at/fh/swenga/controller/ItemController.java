...
public class ItemController {
	...
	public String fillItems(Model model, Authentication authentication) {
		...
		ItemBaseModel item18 = genItem("ChainGlobes", "Heavy but provide good protection", armArmor);
		...
		ItemBaseModel item44 = genItem("ChainBoots", "They are so heavy, they chain you down... Okay im sorry I stop", legArmor);
		...
		itemBaseModelRepository.save(item44);
